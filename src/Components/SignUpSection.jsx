...
const SignUpSection = () => {
    return (
        <div className="registerForm">
            ...
            <a href="#" className="imgAnchor2"><img src={loginBtnImG} className="LoginBTNimg"></img></a>
            <span className="SignUpSpan">Already have an account? <Link to='/signin'><a href="#">Sign in</a></Link></span>
